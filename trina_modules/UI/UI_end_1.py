...
class MyQtMainWindow(QMainWindow):
        ...
        try:
            ...
            if  self.commandQueue:
                ...
                try:
                    ...
                    print("command recieved was " + str(command['funcName']))
                    print("-------------------------------------------------------------")
        except Exception as err:
                print("Error: {0}".format(err))
    ...
    def getRayClick(self):
        ...
        reply = QMessageBox.question(self, "Click Grasping", "If you want to take depth scan you can right click on the map.",
                                    QMessageBox.Yes)
        if reply == QMessageBox.Yes:
